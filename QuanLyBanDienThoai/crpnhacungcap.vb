...
Public Class crpnhacungcap
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QuanLyBanDienThoai.crpnhacungcap.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrpnhacungcap
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpnhacungcap = New crpnhacungcap()
        rpt.Site = Me.Site
        Return rpt
    End Function
