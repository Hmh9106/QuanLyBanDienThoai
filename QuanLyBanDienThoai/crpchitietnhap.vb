...
Public Class crpchitietnhap
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QuanLyBanDienThoai.crpchitietnhap.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrpchitietnhap
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpchitietnhap = New crpchitietnhap()
        rpt.Site = Me.Site
        Return rpt
    End Function
