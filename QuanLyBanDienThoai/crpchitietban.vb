...
Public Class crpchitietban
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QuanLyBanDienThoai.crpchitietban.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrpchitietban
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpchitietban = New crpchitietban()
        rpt.Site = Me.Site
        Return rpt
    End Function
