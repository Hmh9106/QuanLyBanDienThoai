...
Public Class crphoadonban
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QuanLyBanDienThoai.crphoadonban.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrphoadonban
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crphoadonban = New crphoadonban()
        rpt.Site = Me.Site
        Return rpt
    End Function
