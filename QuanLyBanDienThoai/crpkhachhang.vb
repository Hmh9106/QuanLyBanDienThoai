...
Public Class crpkhachhang
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QuanLyBanDienThoai.crpkhachhang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrpkhachhang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpkhachhang = New crpkhachhang()
        rpt.Site = Me.Site
        Return rpt
    End Function
